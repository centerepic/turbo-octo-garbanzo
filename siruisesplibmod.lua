        ...
        for player, objects in next, EspLibrary.espCache do
            ...
            if (character and torso) then
                ...
                if (EspLibrary.options.fillColor ~= nil) then
                    color = Color3.fromRGB(255 * math.abs((player.Character:FindFirstChild("Humanoid").Health - player.Character:FindFirstChild("Humanoid").MaxHealth)/100),255 * math.abs((player.Character:FindFirstChild("Humanoid").Health / player.Character:FindFirstChild("Humanoid").MaxHealth)),0) or Color3.new(1, 0.984313, 0)
                end
